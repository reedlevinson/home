...
Grading will focus on [CS50 coding style](https://github.com/CS50DartmouthSP25/home/blob/main/labs/style.md) - including consistent formatting, selection of identifier names, and use of meaningful comments - in addition to correctness and testing.
...
* Your code must have no memory leaks. We will check!
	* You may find the [**mem** module](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/lab3-mem.md) (provided) useful - or use the native `malloc` and `free`.
	* You may find [valgrind](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/valgrind.md) useful.
* Your module must have a unit-test mechanism, either included within the module code (see, for example, the bottom of `file.c` in the [file module](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/lab3-file.md)) or as a test driver (see, for example, `bagtest.c` in the [bag module](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/lab3-bag.md)).
...
* Your code should, as always, follow [CS50 coding style](https://github.com/CS50DartmouthSP25/home/blob/main/labs/style.md).
...
Allocating an array of pointers can be tricky; recall the unit about [C arrays](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/c-arrays.md).

***Linked lists*** were demonstrated in [sorter4.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter4.c) through [sorter7.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter7.c), although you will need to generalize.
...
Please read those [instructions](https://github.com/CS50DartmouthSP25/home/blob/main/labs/submit.md) carefully!
