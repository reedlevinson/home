 ...
 *  (version 9: unit testing)
 *
 * David Kotz, April-May 2016, April 2017, 2021
 */
...
tree_new(void)
{
  tree_t* tree = mem_malloc(sizeof(tree_t));
...
#ifdef TESTING
  mem_report(stdout, "After tree_insert");
#endif
...
treenode_new(const char* key, void* data)
{
  ...
  treenode_t* node = mem_malloc(sizeof(treenode_t));
...
#ifdef TESTING
  mem_report(stdout, "End of tree_delete");
#endif
}
