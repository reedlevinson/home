...
See example [sorter4.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/sorter4.c).
...
* Some new types might need multiple `malloc` calls, as in our linked-list example [sorter4.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/sorter4.c).
