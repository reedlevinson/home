...
>
> With the same security testing approach, engineers at Google have already found more than [25,000 bugs](https://google.github.io/clusterfuzz/) in Chrome. 75% of these vulnerabilities were [memory issues](https://security.googleblog.com/2022/09/use-after-freedom-miracleptr.html), such as heap buffer overflows and use-after-free. 
>
> The Chromium team has almost completely [automated its security testing efforts for C/C++](https://www.code-intelligence.com/blog/intro-to-oss-fuzz) for memory issues with fuzz testing. [^1]
>
> [^1]: https://www.code-intelligence.com/blog/secure-coding-cpp-using-fuzzing 
