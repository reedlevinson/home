...
The contents of [guess1a.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/guess1a.sh) use the 'while-do' construct.
...
We need to use the more advanced bash operator `[[`, which leads us to [guess1b.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/guess1b.sh).
...
See [guess2.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/guess2.sh):
...
In what follows, we add a function to create [guess3.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/guess3.sh).
...
In [guess4.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/guess4.sh) we now see why it was important to move the user input into a function: because that function can also encapsulate the error-checking code.
