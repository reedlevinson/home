...
Let's look instead at [imagepage.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/imagepage.sh).
...
See example [args.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/args.sh).
...
The two variables `$*` and `$@` both provide the list of command-line arguments, but with subtle differences; again, look at example [args.sh](https://github.com/CS50DartmouthFA25/examples/blob/main/args.sh), to see the difference.
