...
For an example using `realloc`, read about [how readLinep() works](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/readlinep.md).
...
Let's revise our [sorter1.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter1.c) program, using an array of pointers instead of a two-dimensional array of characters: the result is [sorter2.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter2.c).
...
You may want to read more about the [implementation](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/readlinep.md) of `readLinep()`, which is a good example of character-by-character input, string construction, and use of `realloc` to grow an array.

## Example: sorter3

We can extend [sorter2.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter2.c) to sort the array using the library function `qsort()`, which implements the quicksort algorithm, resulting in [sorter3.c](https://github.com/CS50DartmouthSP25/examples/blob/main/sorter3.c).
...
An upcoming unit presents the [valgrind](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/valgrind.md) tool, which helps track memory usage and identify various kinds of memory errors.
