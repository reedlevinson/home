...
You may have studied the example [tree8](https://github.com/CS50DartmouthFA25/examples/blob/main/trees/tree8/), which demonstrated a binary-tree data structure.
Here we enhance it to become [tree9](https://github.com/CS50DartmouthFA25/examples/blob/main/trees/tree9/) (to a computer scientist, `A` comes next after `9`).

Look at [tree9/tree.c](https://github.com/CS50DartmouthFA25/examples/blob/main/trees/tree9/tree.c) and its [Makefile](https://github.com/CS50DartmouthFA25/examples/blob/main/trees/tree9/Makefile).

Like the [glass-box unit test for the **bag** module](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/testing-bag.md),
