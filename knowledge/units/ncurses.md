...
Our examples repo includes a minimal example, [curses.c](https://github.com/CS50DartmouthSP25/examples/blob/main/curse.c).
...
* the C 'switch' statement is a great way to handle keystroke input (recall this [unit](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/c-flow.md#switch)).
...
Our examples repo includes an even cooler example, [Conway's Game of Life](https://github.com/CS50DartmouthSP25/examples/blob/main/life.c).
Compile and run it!
