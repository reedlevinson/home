...
Look at a quick run of the tiny program [arguments.c](https://github.com/CS50DartmouthSP25/examples/blob/main/arguments.c):
...
Study the example [nosort.c](https://github.com/CS50DartmouthSP25/examples/blob/main/nosort.c), which shows one way to parse the command line of a hypothetical replacement for the `sort` command.
