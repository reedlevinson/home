...
We revisit how to turn on/off test code with Makefiles and `#ifdef`, mentioned earlier in a [unit](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/c-conditional-compilation.md) about conditional compilation.
...
**For more examples,** read the next unit about [famous bugs](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/testing-bugs.md).
...
Some of you may like the [mem module](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/lab3-mem.md) to help track the balance of `malloc` and `free` calls.
...
We provide an assert-like function in the [mem module](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/lab3-mem.md), a wrapper for `malloc()`:
