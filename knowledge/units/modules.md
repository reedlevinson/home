...
In our [pointer2.c](https://github.com/CS50DartmouthFA25/examples/blob/main/pointer2.c) example, we passed the address of functions `main` and `change` to `printf` so it could print those addresses for us to examine.
...
We start from [sorter5.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter5.c) and modify it with the goal of coding functions that manipulate a generic "bag of things".
...
[sorter8.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter8.c),
...
A complete *bag* module is included in the [Lab 3 starter kit](https://github.com/CS50DartmouthFA25/home/blob/main/labs/lab3).
