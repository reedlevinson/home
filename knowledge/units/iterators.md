...
Recall the [bag module](https://github.com/CS50DartmouthFA2025/examples/blob/main/bag-unit/bag.c), which has a `bag_iterate()` method:
...
Recall our discussion of *function pointers* from an earlier [unit](https://github.com/CS50DartmouthFA2025/home/blob/main/knowledge/units/modules.md).
...
See [set_iterate1](https://github.com/CS50DartmouthFA2025/examples/blob/main/set_iterate1.c).
...
See [set_iterate2](https://github.com/CS50DartmouthFA2025/examples/blob/main/set_iterate2.c).
(Note also [set_iterate.makefile](https://github.com/CS50DartmouthFA2025/examples/blob/main/set_iterate.makefile).)
