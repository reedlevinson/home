In the [fork unit](https://github.com/CS50DartmouthFA2025/home/blob/main/knowledge/units/fork.md), we saw how an HTTP server could fork (copy itself) to create a *process* to serve each inbound client.
...
Consider the simple example ([print_i.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/threads/print_i.c)), and its output:
...
In the example [random.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/threads/random.c), what gets output first?
...
Consider the output of the [unsafe.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/threads/unsafe.c) example, first with the `c = NULL` commented out, and then with it not commented out.
...
In the example [mutex.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/threads/mutex.c), our goal is to ensure that at any time there is only one thread calling function `print()`.
...
See the [deadlock.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/threads/deadlock.c) example.
