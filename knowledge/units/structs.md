...
In our continuing series of examples, [sorter4.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter4.c), [sorter5.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter4.c), and [sorter6.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter6.c), we declare a `struct listnode` and use it to build a linked list.
...
of [sorter4.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter4.c), which revises [sorter2.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter2.c) to use linked list instead of an array.
...
of [sorter5.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter5.c), which extends [sorter4.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter4.c) to keep the list sorted.
...
of [sorter6.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter6.c), which extends [sorter5.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter5.c) to remove duplicates.
...
of [sorter7.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter7.c), which extends [sorter6.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter6.c) to free the list at the end.
...
The corrected program is now called [sorter6.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter6.c).
...
See example [sorter7.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter7.c).
...
* Some new types might need multiple `malloc` calls, as in our linked-list examples [sorter4.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter4.c), [sorter5.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter5.c), and [sorter6.c](https://github.com/CS50DartmouthFA25/examples/blob/main/sorter6.c).
