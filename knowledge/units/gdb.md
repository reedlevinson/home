...
If you do use `printf` debugging, please use the C preprocessor to conditionally turn on/off the debugging output with one switch; that is, using `#ifdef DEBUG` and [conditional compilation](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/c-conditional-compilation.md).
...
See our [gdb resources](https://github.com/CS50DartmouthSP25/home/blob/main/logistics/systems.md#gdb) for manuals and tutorial documents.
...
We will be working with [bugsort.c](https://github.com/CS50DartmouthSP25/examples/blob/main/bugsort.c).
