...
Before continuing, follow these [instructions](https://github.com/CS50DartmouthFA25/home/blob/main/logistics/systems.md#linux) to set up your Linux account... so you can experiment as you read the following.
...
See [about editors](https://github.com/CS50DartmouthFA25/home/blob/main/logistics/systems.md#editors) for some resources that can help you learn `emacs` or `vim`.
