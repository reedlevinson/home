...
Let's rewrite our original example, [client-server](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server) with UDP "datagrams" instead of TCP "streams".
See the [client-server-udp](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-udp) example.
...
In the above UDP client-server [example](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-udp), the client sends datagrams to a server, and the server echos them back to the client.
...
From `chatserver1.c` in the new [example](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-udp-select):
...
See `chatclient2.c` and `chatserver2.c` in the new [example](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-udp-select).
...
Take a good look at the code for both `chatclient2.c` and `chatserver2.c` in the new [example](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-udp-select) - including the functions I did not include above - to better understand sockets, datagrams, and `select`.
Have fun!
