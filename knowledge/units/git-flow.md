The slides are [here](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/media/git-flow/gitflow-slides-new.pdf).

Recall the [unit about merge conflicts](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/git-conflict.md).
...
If the `main` branch is *protected* (as it should be; see this [unit](https://github.com/CS50DartmouthFA25/home/blob/main/knowledge/units/protect-main.md)),
