...
* [pointer0.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointer0.c)
* [pointer1.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointer1.c)
* [pointer2.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointer2.c)
* [pointer3.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointer3.c)
* [crash.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/crash.c)
* [sorter2.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/sorter2.c)

Since then, we added another example:

* [pointers.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointers.c)
...
> Compile and run [crash.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/crash.c) to experience this 'segfault' for yourself!
...
The [pointers.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/pointers.c) example does a nice job of explaining and demonstrating the fact that pointers are just addresses, and distinguishing these four regions.
...
Let's look at [crash.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/crash.c) to see what happens when we dereference a NULL pointer.
