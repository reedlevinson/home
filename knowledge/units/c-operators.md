...
Take a close look at the output of [increment.c](https://github.com/CS50DartmouthFA25/examples/blob/main/increment.c):
...
Explore the example [combined.c](https://github.com/CS50DartmouthFA25/examples/blob/main/combined.c).
