As we saw in the [unit about naming in C](https://github.com/CS50DartmouthFA2025/home/blob/main/knowledge/units/c-names.md), in C you can name constants, variables, functions, and even types.
...
For example, look at [guess6.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/guess6.c), which declares three functions near the top:
...
Look again at [guess6.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/guess6.c); because it includes [readline.h](https://github.com/CS50DartmouthFA2025/examples/blob/main/readline.h) near the top, the code from that file is incorporated into `guess6` right at that point, including the line

```c
extern bool readLine(char* buf, const int len);
```

Later, in a separate run of the compiler, [readline.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/readline.c) *also* includes [readline.h](https://github.com/CS50DartmouthFA2025/examples/blob/main/readline.h) near the top of its file, declaring function `readLine()`.
...
> Look again at [guess6.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/guess6.c); the three functions it declares and defines are not marked `static` or `extern`; they would thus be potentially visible to other code modules linked with this program.
...
For example, we diagram the core of [sqrt.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/sqrt.c) below.
