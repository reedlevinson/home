...
From [getput.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/getput.c):
...
Sometimes, it is convenient to read input line by line; for that we recommend the `readline()` function from [readline.c](https://github.com/CS50DartmouthFA2025/examples/blob/main/readline.c).
