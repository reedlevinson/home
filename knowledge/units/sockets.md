...
In this example, [client-server](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server), we see a basic TCP client that can talk to our basic TCP server.
...
In this example, [client-server-http](https://github.com/CS50DartmouthSP25/examples/blob/main/client-server-http), we enhance the basic example to support HTTP.
