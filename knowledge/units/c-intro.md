...
In class we iteratively build a C version of our friend [guess1a.sh](https://github.com/CS50DartmouthSP25/examples/blob/main/guess1a.sh), and then enhance it.
...
> [Lab0](https://github.com/CS50DartmouthSP25/home/blob/main/labs/lab0), specifically,
...
[guess1.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess1.c): (simple replacement for the bash program)
...
[guess2.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess2.c): (provide the user guidance toward answer)
...
[guess3.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess3.c): (move the repeated code into a function)
...
[guess4.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess4.c): (move the function to the bottom, so main() stays at top)
...
[guess5.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess5.c): (add command-line arguments, check validity of guess, allow them to quit early)
...
[guess6.c](https://github.com/CS50DartmouthSP25/examples/blob/main/guess6.c): (read input as a string, convert to integer, check input more carefully)

This example takes a major step forward, by leveraging a separate module I've written, in `readline.c` and `readline.h`.
(See the unit about the [compilation process](https://github.com/CS50DartmouthSP25/home/blob/main/knowledge/units/c-compile.md).)
...
Another example, which explores the same `sscanf` trick used in `guess6`, is [atoi.c](https://github.com/CS50DartmouthSP25/examples/blob/main/atoi.c).
