...
We saw an example of this concept when chopping up 'csv' (comma-separated values) data from the vaccine dataset, in the [covid example](https://github.com/CS50DartmouthFA2025/examples/blob/main/covid/covid.c).
